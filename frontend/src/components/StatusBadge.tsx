...
const StatusBadge: React.FC<Props> = ({ status }) => {
    ...
    const normalizedStatus = status === 'SENT' ? 'COMPLETED' : status;
    ...
    const styles: Record<string, string> = {
        ...
        SENT: "bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400 border-green-200 dark:border-green-900", // Fallback
